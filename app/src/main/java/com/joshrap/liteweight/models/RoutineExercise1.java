...
@Data
public class RoutineExercise1 implements Model, Cloneable {
    ...
    public RoutineExercise1(RoutineExercise1 toBeCopied) {
        ...
        this.index = toBeCopied.index; // eh
    }

    public RoutineExercise1(Map<String, Object> json) {
    ...
    public RoutineExercise1(OwnedExercise ownedExercise, String exerciseId) {
    ...
    static boolean exercisesDifferent(RoutineExercise1 exercise1, RoutineExercise1 exercise2) {
