...
public class CustomSortAdapter1 extends RecyclerView.Adapter<CustomSortAdapter1.ViewHolder> {
    ...
    private final List<RoutineExercise1> exercises;
    private final Map<String, String> exerciseIdToName;
    private final boolean metricUnits;

    public CustomSortAdapter1(List<RoutineExercise1> routineExercises, Map<String, String> exerciseIdToName, boolean metricUnits) {
    ...
    @NonNull
    @Override
    public CustomSortAdapter1.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(CustomSortAdapter1.ViewHolder holder, int position) {
        RoutineExercise1 exercise = exercises.get(position);
