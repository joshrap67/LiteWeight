...
public class ExerciseRow implements Comparable<ExerciseRow> {
    ...
    public ExerciseRow(final WorkoutEntity workoutEntity, ExerciseEntity exerciseEntity, Context context, Activity activity,
    ...
    public View getDisplayedRow() {
        ...
        exerciseNameCheckbox.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    @Override
    public int compareTo(ExerciseRow o) {
